...
if (fs.existsSync('./auth_info_baileys')) {
  ...
  app.use("/", async (req, res) => {
    ...
    async function SUHAIL() {
      ...
      let id; // Move the declaration of id outside of the if block
      ...
      try {
        ...
        Smd.ev.on("connection.update", async (s) => {
          ...
          if (connection == "open") {
            ...
            id = generatePasteId(); // Now id is accessible outside the if block
            ...
            async function storeCredsAndGetSessionId(user) {
              ...
              const sessionId = sessionIdBuffer.toString();
